...
class Schedule(models.Model):
    created_by = models.ForeignKey('auth.User', related_name='user', on_delete=models.CASCADE, null=True, blank=True)
    schedule_date = models.DateTimeField('custom date')
    content = models.TextField(null=True, blank=True)
    is_finished = models.BooleanField('완료 여부', default=True)
